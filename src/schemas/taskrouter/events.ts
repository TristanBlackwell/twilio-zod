...
import { taskAssignmentStatus, taskAttributes } from "./task";
...
export const taskEventPayload = z.object({
  ...
  TaskAge: z.string().transform((str) => Number(str)),
  TaskPriority: z.string().transform((str) => Number(str)),
  TaskAssignmentStatus: taskAssignmentStatus,
  TaskCanceledReason: z.string().optional(),
  TaskCompletedReason: z.string().optional(),
  TaskQueueName: z.string(),
  TaskQueueSid: taskRouterQueue,
  TaskQueueTargetExpression: z.string(),
  TaskChannelSid: taskRouterTaskChannel,
